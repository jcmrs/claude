...
**Example queries:**
- `/docs How does the memory system work?` → Wiki → Components → Memory System
- `/docs What is the response protocol?` → Wiki → Protocols → Response Protocol
- `/docs How do I structure sessions?` → Tutorials → Competency 1
...
This plugin is developed for the Claude Collaboration Platform and follows the platform's skill patterns:
